...
#     print(im.size())
#     im = F.upsample(
# im, size=(im.size(2)//2, im.size(3)//2), mode='bilinear')
#     save_image(
# im, './dsprites-dataset/images/'+(str)(labels[i][1])+'/
# '+str(labels[i][2])+'_'+str(labels[i][3])+'_'+str(labels[i][4])+
# '_'+str(labels[i][5])+'.png', normalize=True)
...
for pair in range(num_pairs):
    ...
    motion = random.sample(range(4), 2)
