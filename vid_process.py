...
def resize_cropped(filename, side):
    """resize video denoted by filename to
    (side x side) video and output it as a
    numpy array of (frames x h x w x 3)"""
...
def resize_keepAR(filename, h_0, write):
    """resize video denoted by filename to make height h_0
    keeping aspect ratio, write it and output it as a numpy
    array of (frames x h x w x 3)"""
